<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AddWork.aspx.cs" Inherits="PraksaFront.WebForm2" %>
                ...
                <tr>
                    <td colspan="2">
                        <div class="text-center">
                            <asp:Button OnCommand="Submit_Command" Style="display: inline-block; text-align: center; margin-right: 10px;" ID="Button1" runat="server" Text="Potvrdi" />
                            <asp:Button OnCommand="Cancel_Command" Style="display: inline-block; text-align: center; margin-left: 10px;" ID="Button2" runat="server" Text="Odustani" />
                        </div>
                    </td>
                </tr>
            </table>
