...
namespace PraksaFrontMVC.Controllers
{
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IdName,IdUser")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IdName,IdUser")] Role role)
        {
            if (id != role.Id)
            {
                return NotFound();
